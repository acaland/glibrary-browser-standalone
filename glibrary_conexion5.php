...
///////////////////////SELECT FUNCTION/////////////////////////	
  	switch($task){
		...
		case "HIDDENFIELD":
			...
			break;	
		case "VISIBLEFIELD":	//Give the values of VisibleAtrrs.
...
//////////////////////////FUNCTIONS/////////////////////////////
	...
	*/
	...
	function visibleFields($IsCollection){
		...
		echo json_encode($glibrary->getVisibleFields());
	}
